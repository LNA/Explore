(meditations
  ...
  (= '((0 1 2) (5 6 7) (10 11 12)) (partition 3 5 (range 13))) ;why 10, 11 12?
  ; my example:
  (= ((0 1 2) (7 8 9))(partition 3 7 (range 13)))
  ...
  (= '((0 1 2) (3 4 5) :this :are) (partition 3 3 [:this :are "my" "words"] (range 7))))
